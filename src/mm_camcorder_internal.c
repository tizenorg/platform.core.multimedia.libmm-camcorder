...
int _mmcamcorder_set_video_stream_callback2(MMHandleType handle, mm_camcorder_video_stream_callback callback, void *user_data)
{
	mmf_camcorder_t *hcamcorder = MMF_CAMCORDER(handle);
	...
	hcamcorder->vstream_cb2 = callback;
	hcamcorder->vstream_cb2_param = user_data;
